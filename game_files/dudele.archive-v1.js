/*    *****************************************************************************
      ...
      ***************************************************************************** */
(this.dudele = this.dudele || {}),
  (this.dudele.bundle = (function (e) {
    "use strict"; 
    function a(e) {
      return (a =
...
//Moved array of dictionary from here to top for early definition - this is needed for random letter words. 
    ...
    if (window.localStorage.getItem("dudele-language") == "fr") {
      // FRENCH
      Ka.innerHTML =
    ...
    var Za = "IN_PROGRESS",
      ...
      ts = (function (e) {
        ...
        function t() {
          ...
          if (window.localStorage.getItem("dudele-language") == null) {
            window.localStorage.setItem("dudele-language", "en");
          }
          var o = za();
          if (window.localStorage.getItem(archiveDate) == null) {
            var todayGame = Ga(new Date()) - 313;
        ...
        return (
          o(t, [
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                var currentGame = Ga(new Date()) - 313;
                ...
                (this.shadowRoot.querySelector("#dudele-title").textContent = 
                  "DUDELE DAY#".concat(Ga(new Date(JSON.parse(window.localStorage.getItem(archiveDate)))) - 313)),
    ...
    var isFrench = window.localStorage.getItem("dudele-language") == "fr";
    if (isFrench) {
      Cs.innerHTML =
          ...
          o(t, [
            {
              ...
              value: function () {
				...
				"Madam C.J. Walker (born Sarah Breedlove) was an African American entrepreneur, philanthropist, and political and social activist. She is recorded as the first female self-made millionaire in America in the Guinness Book of World Records. Walker made her fortune by developing and marketing a line of cosmetics and hair care products through the business she founded, Madam C. J. Walker Manufacturing Company.", /*2 madam*/ 
                ...
                announcement.innerHTML = '<style> a {color: var(--orange);} a:hover {color: var(--green);}</style> <center style="font-size:12px", "acolor: #FF0000">Follow us <a href="https://www.twitter.com/DudeleGame" target="_blank"><strong>@DudeleGame</strong></a> on <strong>Twitter!<strong></center>';
